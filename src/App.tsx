  ...
  return (
    ...
    >
      ...
      <div className="productStoryIntro" data-reveal>
        ...
        <p>Параметры сырья, способ подготовки и документы согласуются до отправки конкретной партии.</p>
      </div>
  ...
  return (
    ...
    >
      ...
      <div className="productStoryIntro" data-reveal>
        ...
        <p>Ресурс, подготовка и документы выстраиваются в одну понятную цепочку для технолога и отдела закупок.</p>
      </div>
    ...
    >
      ...
      <section className="section documentsSlide snapSlide darkSlide" id="documents" data-slide>
        ...
        <div className="sectionIntro" data-reveal>
          ...
          <p>
            Паспорт качества, протокол анализа, сведения о происхождении
            и условия отгрузки собраны для первичной проверки.
          </p>
        </div>
      ...
      <section className="section articlesBand snapSlide" id="articles" data-slide>
        ...
        <div className="sectionIntro" data-reveal>
          ...
          <p>
            Короткие материалы о составе, документах, применении сырья и логистике.
          </p>
        </div>
